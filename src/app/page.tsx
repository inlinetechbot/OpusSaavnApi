export default function Home() {
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 bg-[#1f5c52]">
        <div className="absolute -top-32 -left-20 w-[32rem] h-[32rem] rounded-full bg-[#7be3a8] opacity-40 blur-3xl animate-[float1_16s_ease-in-out_infinite]" />
        <div className="absolute top-10 right-[-6rem] w-[28rem] h-[28rem] rounded-full bg-[#6ecbe8] opacity-30 blur-3xl animate-[float2_20s_ease-in-out_infinite]" />
        <div className="absolute bottom-[-8rem] left-1/4 w-[36rem] h-[36rem] rounded-full bg-[#e8c96e] opacity-30 blur-3xl animate-[float3_24s_ease-in-out_infinite]" />
        <div className="absolute bottom-0 right-0 w-full h-full bg-gradient-to-br from-transparent via-transparent to-[#1a3d38]" />
      </div>
      ...
      <style>{`
        @keyframes float1 {
          ...
          50% { transform: translate(6rem, 4rem) scale(1.15); }
        }
        @keyframes float2 {
          0%, 100% { transform: translate(0, 0) scale(1); }
          50% { transform: translate(-5rem, 6rem) scale(1.1); }
        }
        @keyframes float3 {
          0%, 100% { transform: translate(0, 0) scale(1); }
