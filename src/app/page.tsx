    ...
    <div className="min-h-screen bg-[#fafafa] text-[#1a1a2e]">
      ...
      <section className="max-w-3xl mx-auto px-5 md:px-8 py-16">
        <div className="text-center mb-8">
          <div className="inline-block px-4 py-1.5 rounded-full bg-[#fff1ea] text-[#ff6b35] text-xs font-semibold tracking-wide uppercase">
            Created By
          </div>
        </div>

        <div className="rounded-2xl border border-black/5 bg-white shadow-sm divide-y divide-black/5 overflow-hidden">
          <div className="p-8">
            <h3 className="text-2xl font-bold">MrDeep</h3>
            <div className="flex flex-wrap gap-3 mt-4">
              <a
                ...
                aria-label="Telegram"
                className="flex items-center justify-center w-11 h-11 rounded-lg border border-black/10 hover:bg-black/5 transition-colors"
              >
          ...
          <div className="p-8">
            <h3 className="text-2xl font-bold">Miss Cherry</h3>
            <div className="flex flex-wrap gap-3 mt-4">
              <a
